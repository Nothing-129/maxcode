...
export function SidebarWordmark() {
  ...
  return (
    <span
      role="img"
      aria-label="MaxCode"
      className="inline-flex shrink-0 items-center gap-2.5 select-none"
    >
      <svg
        aria-hidden="true"
        focusable="false"
        viewBox="0 0 12 24"
        className={`h-6 w-3 text-[#285ee1] dark:text-[#82a4ff] ${styles.slash}`}
      ...
      >
        ...
        <g className={styles.glow}>
          <path
            className={styles.gradientStroke}
            d="M9 4 3 20"
      ...
      <span aria-hidden="true" className="flex items-baseline leading-none">
        <span className="text-[21px] font-bold tracking-[-0.065em] text-sidebar-foreground">
          Max
        </span>
        <span className="font-mono text-[19px] font-medium tracking-[-0.075em] text-sidebar-foreground/70">
          Code
        </span>
      </span>
    </span>
