...
mod tauri_app {
    ...
    use crate::commands::{
        ...
        conversation_share as conversation_share_commands, conversations,
    ...
    pub fn run() {
        ...
        builder
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                system_settings::get_system_title_model_settings,
                system_settings::update_system_title_model_settings,
                system_settings::test_system_title_model_settings,
                ...
                commands::conversation_read::get_conversation_reads,
                commands::conversation_read::mark_conversations_read,
